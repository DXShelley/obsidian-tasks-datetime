...
> If all the checkboxes look the same in Reading Mode or Live Preview, see [Style custom statuses](https://github.com/DXShelley/obsidian-tasks-datetime/tree/main/docs) for how to select a theme or CSS snippet to style your statuses.
